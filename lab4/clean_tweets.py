...
# We know that tweet_text column has missing value
# Tweet IDs may be duplicated
# Likes supposed to be numerical value, but we have string value here
# Same country, date time, is not unified in terms of value
# Minimum retweets have impossible value
...
# Task 6 Standardize Catogories and Strings
df["platform"] = (
...
# Clean supplied sentiment labels if the dataset includes them
if "sentiment_raw" in df.columns:
    ...
    print(
        "No sentiment_raw column; "
        "sentiment will be estimated with RoBERTa."
    )
...
# Task 9 Create a Document-Term Matrix
print(dtm.shape)
